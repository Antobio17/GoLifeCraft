...
final class LoadMenuIntoDiaryController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new LoadMenuIntoDiaryCommand(
                ...
                loadedByUserId: RequestExtractor::getUserSessionId(request: $request),
            ));
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    LoadMenuIntoDiaryException::class => Response::HTTP_BAD_REQUEST,
                ]
            );
