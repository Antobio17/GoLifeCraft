...
final class UpdateShoppingListItemController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new UpdateShoppingListItemCommand(
                shoppingListItemId: $request->attributes->get(key: 'shoppingListItemId'),
                quantity: RequestExtractor::getIntRequestValue(request: $request, fieldName: 'quantity'),
                checked: RequestExtractor::getBooleanRequestValue(request: $request, fieldName: 'checked', nullable: false),
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    UpdateShoppingListItemException::class => Response::HTTP_BAD_REQUEST,
                ]
            );
