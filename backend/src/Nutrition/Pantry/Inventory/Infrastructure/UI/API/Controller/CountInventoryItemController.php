...
final class CountInventoryItemController
{
    use HandleTrait;
    ...
    public function __invoke(Request $request, string $inventoryId, string $itemId): JsonResponse
    {
        try {
            $this->handle(message: new CountInventoryItemCommand(
