...
use Nutrition\Kitchen\Production\Application\Query\GetProductionsQuery;
...
final class GetProductionsController
{
    use HandleTrait;
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            return JsonResponseBuilder::buildCollectionResponse(
                queryCollectionResult: $this->handle(message: new GetProductionsQuery(
