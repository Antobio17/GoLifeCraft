...
final class GetArticleResult extends QueryAggregateResult
{
    ...
    public function __construct(
        ...
        public readonly float $stockConfidence,
        public readonly ?float $stockUncertainty,
        public readonly ?float $stockMinQuantity,
        public readonly ?float $stockMaxQuantity,
        public readonly string $stockLevel,
        public readonly ?float $stockReferenceQuantity,
        public readonly ?\DateTime $stockObservedAt,
