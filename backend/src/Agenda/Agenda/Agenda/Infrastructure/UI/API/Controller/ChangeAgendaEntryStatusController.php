...
final class ChangeAgendaEntryStatusController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new ChangeAgendaEntryStatusCommand(
                agendaEntryId: $request->attributes->get(key: 'agendaEntryId'),
                done: RequestExtractor::getBooleanRequestValue(request: $request, fieldName: 'done', nullable: false),
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    UpdateAgendaEntryException::class => Response::HTTP_NOT_FOUND,
                ]
            );
