...
final class DeleteAgendaEntrySeriesController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new DeleteAgendaEntrySeriesCommand(
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    DeleteAgendaEntrySeriesException::class => Response::HTTP_NOT_FOUND,
