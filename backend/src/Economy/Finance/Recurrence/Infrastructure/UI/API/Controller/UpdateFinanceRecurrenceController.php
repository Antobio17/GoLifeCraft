...
final class UpdateFinanceRecurrenceController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new UpdateFinanceRecurrenceCommand(
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    UpdateFinanceRecurrenceException::class => Response::HTTP_BAD_REQUEST,
                ]
            );
