...
final class EditWorkoutController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new EditWorkoutCommand(
                ...
                startedAt: RequestExtractor::getDateTimeRequestValue(request: $request, fieldName: 'startedAt'),
                ...
                editedByUserId: RequestExtractor::getUserSessionId(request: $request),
            ));
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    EditWorkoutException::class => Response::HTTP_BAD_REQUEST,
                    UpdateWorkoutException::class => Response::HTTP_BAD_REQUEST,
                ]
            );
