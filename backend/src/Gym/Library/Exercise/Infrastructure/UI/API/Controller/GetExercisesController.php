...
use Gym\Library\Exercise\Application\Query\GetExercisesQuery;
...
final class GetExercisesController
{
    use HandleTrait;
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            return JsonResponseBuilder::buildCollectionResponse(
                queryCollectionResult: $this->handle(message: new GetExercisesQuery(
                    ...
                    filterType: RequestExtractor::getFilterParam(request: $request, filterName: 'type'),
                    filterMuscleGroup: RequestExtractor::getFilterParam(request: $request, filterName: 'muscleGroup'),
