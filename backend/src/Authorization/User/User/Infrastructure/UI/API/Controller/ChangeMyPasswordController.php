...
final class ChangeMyPasswordController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new ChangeMyPasswordCommand(
                userSessionId: RequestExtractor::getUserSessionId(request: $request),
                currentPassword: RequestExtractor::getStringRequestValue(request: $request, fieldName: 'currentPassword'),
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    ChangeMyPasswordException::class => Response::HTTP_BAD_REQUEST,
                ]
            );
