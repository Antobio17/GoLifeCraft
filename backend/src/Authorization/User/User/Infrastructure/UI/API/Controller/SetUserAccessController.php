...
final class SetUserAccessController
{
    use HandleTrait;
    ...
    {
        try {
            $this->handle(message: new SetUserAccessCommand(
                userId: $request->attributes->get(key: 'id'),
                isActive: RequestExtractor::getBooleanRequestValue(request: $request, fieldName: 'isActive', required: true, nullable: false),
            ...
            return JsonResponseBuilder::buildResponseFromBaseHandlerFailedException(
                exception: $e,
                exceptionStatusMap: [
                    SetUserAccessException::class => Response::HTTP_FORBIDDEN,
                ]
            );
